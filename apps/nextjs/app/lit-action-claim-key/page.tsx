...
import { runExample } from "../../../../lit-action-claim-key/nodejs/src/index";

const OPERATIONS: Operation[] = [
    {
        id: "lit-action-claim-key",
        name: "Demonstrate a Lit Action to claiming a key based on usedId",
        handler: runExample,
    },
];

export default function LitActionClaimKey() {
    const { state, executeOperation } = useOperation();

    return (
        <div className="flex flex-col items-center gap-[1.2rem]">
            <h2 className="text-xl font-semibold mb-4">Lit Action a Claiming Key</h2>
