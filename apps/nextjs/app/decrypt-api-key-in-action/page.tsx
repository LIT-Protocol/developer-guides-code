...
import { decryptApiKey } from "../../../../decrypt-api-key-in-action/nodejs/src/index";

const OPERATIONS: Operation[] = [
    {
        id: "decrypt-api-key-in-action",
        name: "Demonstrate Decrypt API Key in a Lit Action",
        handler: () =>
            decryptApiKey(
